...
using RajaMotors.Web.Models;
using RajaMotors.Service;
using RajaMotors.Web.Helpers;
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            if (Request.QueryString["guid"] != null)
                RajaMotorsSessionFacade.JoinGroupOrGoal = Request.QueryString["guid"];
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (RajaMotorsSessionFacade.JoinGroupOrGoal != null)
                    {
                        string groupOrGoalJoinToken = RajaMotorsSessionFacade.JoinGroupOrGoal;
        ...
        public ActionResult EditProfile(UserProfileFormModel editedProfile)
        {
            ...
            Model.Models.ApplicationUser applicationUser = userService.GetUser(editedProfile.UserId);
        ...
        private async Task SignInAsync(Model.Models.ApplicationUser user, bool isPersistent)
        {
